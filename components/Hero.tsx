    ...
    <section className="pt-32 pb-20 px-4 sm:px-6 lg:px-8 relative">
      ...
      <div className="max-w-4xl mx-auto text-center">
        <motion.div
          ...
          className="bg-[#1a1a2e] border-2 border-white rounded-sm p-8 mb-8"
        >
          ...
          <motion.h1
            ...
            className="text-5xl sm:text-6xl font-bold mb-4 text-blue-400"
          >
            Hi! I'm Cole :)
          </motion.h1>
          <motion.h2
            ...
            className="text-2xl sm:text-3xl mb-8 text-white"
          >
